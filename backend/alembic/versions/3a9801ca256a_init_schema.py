...
def upgrade() -> None:
    ...
    sa.Column('servings', postgresql.JSONB(astext_type=sa.Text()), server_default='[]', nullable=False),
    ...
    op.create_index('ix_meals_user_type_eaten', 'meals', ['user_id', 'meal_type', 'eaten_at'], unique=False)
    op.create_index('uq_meals_user_tg_msg', 'meals', ['user_id', 'tg_message_id'], unique=True, postgresql_where='tg_message_id IS NOT NULL')
    ...
    op.create_index(op.f('ix_meal_items_food_name'), 'meal_items', ['food_name'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('uq_meals_user_tg_msg', table_name='meals', postgresql_where='tg_message_id IS NOT NULL')
